...
public class RobotstxtPathRuleTest {
    ...
    public void testPattern() {
        ...
        assertEquals(true, PathRule.matchesRobotsPattern("/abc/*/favicon.ico", "/abc/site1/favicon.ico"));
        assertEquals(false, PathRule.matchesRobotsPattern("/abc/*/othericon.ico", "/abc/site1/favicon.ico"));

        assertEquals(true, PathRule.matchesRobotsPattern("/private*/", "/privateFiles/secret.txt"));
        assertEquals(true, PathRule.matchesRobotsPattern("/private*/", "/private/images/secret.img"));
        assertEquals(false, PathRule.matchesRobotsPattern("/private*/", "/public/private/images/secret.img"));
        ...
        assertEquals(false, PathRule.matchesRobotsPattern("/*?$", "/some/weird/path.php?query=true"));
        ...
        assertEquals(false, PathRule.matchesRobotsPattern("/a\\*/escaped/path", "/another/escaped/path"));
    }
}
