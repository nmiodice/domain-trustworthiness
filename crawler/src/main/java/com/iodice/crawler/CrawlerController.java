...
public class CrawlerController {
    ...
    public CrawlerController(List<String> seeds) {
        this();
        Validate.notNull(seeds, "cannot initialize com.iodice.crawler with null seed list");
        Validate.isFalse(seeds.isEmpty(), "cannot initialize com.iodice.crawler with 0 seeds");
        Validate.noNullElements(seeds.toArray(), "cannot initialize com.iodice.crawler with null seed elements");
        this.seeds = seeds;
    }
